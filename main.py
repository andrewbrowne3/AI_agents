...
for idx, wiki_title in enumerate(wiki_titles):
    ...
    if not os.path.exists(f"./data/Cities/{wiki_title}"):
        # build vector index
        ...
        vector_index = load_index_from_storage(
            StorageContext.from_defaults(persist_dir=f"./data/Cities/{wiki_title}"),
...
response = agent.chat(
    input("What Cities do you want to know about")
)